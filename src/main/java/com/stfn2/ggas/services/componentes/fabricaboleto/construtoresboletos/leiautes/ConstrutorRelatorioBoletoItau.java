 ...
 */
public class ConstrutorRelatorioBoletoItau extends ConstrutorRelatorioBoleto {

	private static final String MSG_LOCAL_PAGAMENTO = 
			"ATÉ O VENCIMENTO EM QUALQUER BANCO OU CORRESPONDENTE NÃO BANCÁRIO. APÓS O VENCIMENTO, ACESSE "
			+ "ITAU.COM.BR/BOLETOS E PAGUE EM QUALQUER BANCO OU CORRESPONDENTE NÃO BANCÁRIO";
	 ...
	 */
	public ConstrutorRelatorioBoletoItau(DocumentoCobranca documentoCobranca) throws NegocioException {
